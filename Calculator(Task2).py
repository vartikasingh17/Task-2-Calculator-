...
ent_field = tk.Entry(root, bg='#DDA0DD', fg='#FF00FF', font=('Arial', 25),
...
btn_pi = tk.Button(root, text='\u03C0', command=lambda: sc_app.Pi(),
                   font=FONT, width=5, height=2, fg='#00BFFF',
                   highlightbackground='#FF00FF', highlightthickness=2)
...
btn_abs = tk.Button(root, text='Abs', command=lambda: sc_app.Abs(),
                    font=FONT, width=5, height=2, fg='#00BFFF',highlightbackground= '#FF00FF', highlightthickness=2)
